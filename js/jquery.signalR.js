        ...
        start: function (connection, onSuccess, onFailed) {
            ...
            if (!connection.socket) {
                if (connection.webSocketServerUrl) {
                    url = connection.webSocketServerUrl + 'micc.r3yun.com';
                } else {
                    url = connection.wsProtocol + 'micc.r3yun.com';
...
(function ($, window, undefined) {
    ...
    hubConnection.fn.init = function (url, options) {
        ...
        connection.received(function (minData) {
            var data, dataCallbackId,proxy, callback, hubName, eventName;
            if (!minData) {
                return;
            }
            ...
            if (typeof (minData.I) !== "undefined") {
                ...
                console.log(this.proxies,hubName);
                console.log(eventName);
                console.log(data);
                console.log(this.proxies.employeehub.hubName);
                // Trigger the local invocation event
                proxy = this.proxies[hubName];
                //  proxy = this.proxies.employeehub.hubName;
